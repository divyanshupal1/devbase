...
export const DropItem = ({title,icon,action,className,animate=false}:{title:string,icon?:React.ReactNode,action:()=>void,className?:string,animate?:boolean}) => {
...
export const DropDownItems = ({children,className}:{children:React.ReactNode,className?:string}) => {
...
export const DropDownHeader = ({children,className,openClasses}:{children:React.ReactNode,className?:string,openClasses?:string}) => {
    const open = useContext(DropDownContext)
    return (
      <motion.button
      initial={false}
...
export const HeaderIcon = ({children,rotate=false}:{children:React.ReactNode,rotate?:boolean}) => {
    return (
        <motion.div
        variants={rotate?{
          open: { rotate: 180 },
